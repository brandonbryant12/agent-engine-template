...
- [`issue-evaluator`](../../automations/issue-evaluator/issue-evaluator.md): repository stewardship lane that evaluates all open issues and applies `ready-for-dev`, `rejected`, or `human-eval-needed`.
